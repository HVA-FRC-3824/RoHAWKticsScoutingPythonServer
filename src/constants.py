class Constants:
    ...
    ENDGAME_CLIMB_CREDITTED_THROUGH_FOUL = "creditted_through_foul"
    ENDGAME_CLIMB_CREDITTED_THROUGH_FOUL_KEY = "Creditted through foul"
    ENDGAME_CLIMB_OPTIONS = {ENDGAME_CLIMB_SUCCESSFUL: ENDGAME_CLIMB_SUCCESSFUL_KEY,
                             ...
                             ENDGAME_CLIMB_CREDITTED_THROUGH_FOUL: ENDGAME_CLIMB_CREDITTED_THROUGH_FOUL_KEY}
